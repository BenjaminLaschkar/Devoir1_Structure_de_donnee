...
template<typename T>
const T & File<T>::premier() const {}	// TODO: insérer une instruction return ici

template<typename T>
const T & File<T>::dernier() const {}	// TODO: insérer une instruction return ici

template<typename T>
const File<T>& File<T>::operator=(const File<T>&f) {} //throw(bad_alloc) ==> TODO: insérer une instruction return ici
